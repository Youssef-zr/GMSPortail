<div class="row">
    ...
    <div class="col-12 col-md-4 col-lg-3">
        <div class="form-group {{$errors->has('IDType') ? 'has-error' : ''}}">
            <div class="option">
                {!! Form::label('IDType', 'type document', ['class'=>'form-label']) !!}
                <span class="star text-danger">*</span>
            </div>
            {!! Form::select("IDType", $typesDocument, old('IDType'), ['class'=>'form-control',"placeholder"=>"type de document"]) !!}
...
<div class="row">
    ...
    <div class="col-12 col-md-4 col-lg-3">
        <div class="form-group">
            ...
            <a href="{{ url($document->chemin) }}" class="d-block">{{ $document->nom_fichier }}</a>
        </div>
    </div>
    @endif
...
<div class="form-group">
    <button class="btn {{ isset($document) ? "bg-warning" : "bg-primary" }}"><i class="fa fa-floppy-o float"></i> enregistrer </button>
</div>
{{-- End row --}}
