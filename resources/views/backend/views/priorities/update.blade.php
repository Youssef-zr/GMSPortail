...
@section('braidcrump')
    ...
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><i class="fa fa-sort-numeric-desc"></i> priorités</h1>
            </div>
            <div class="col-sm-6">
      ...
      <div class="col-xl-12">
        <div class="card card-warning mg-b-20">
          <div class="card-header">
              <h3><i class="fa fa-pencil-circle"></i> {{ $title }} </h3>
          </div>
          <div class="card-body">
              {!! Form::model($priorite,['route'=>['priorites.update',$priorite->id],'method'=>'patch']) !!}
                  @include('backend.views.priorities.form')
              {!! Form::close() !!}
          </div>
        </div>
      </div>
