                                            ...
                                            <table id="example" class="stripe row-border order-column" style="width:100%">
                                                ...
                                                <tbody>
                                                    @foreach ($plannings as $planning)
                                                        <tr>
                                                            <td>
                                                                {{ $planning->client->raison_sociale }}
                                                            </td>
                                                            <td>
                                                                {{ $planning->email }}
                                                            </td>
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu" role="menu">
                                                                        ...
                                                                        {{-- @can('editer_planning') --}}
                                                                        <label class="dropdown-item">
                                                                            <a href="{{ route('plannings.show', $planning->id) }}"
                                                                                class="btn bg-primary btn-block btn-flat text-left"
                                                                                title='afficher' data-toggle="tooltip"><i
                                                                                    class="fa fa-eye"></i> planning</a>
                                                                        </label>
                                                                        {{-- @endcan --}}

                                                                        {{-- @can('supprimer_planning') --}}
                                                                        <label class="dropdown-item">
                                                                            <a href="#"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">supprimer le calendrier ?</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center">
                            êtes-vous sûr de supprimer ce calendrier des enregistrements ?
                        </p>
                    </div>

                    <!-- Modal footer -->
                    <div class="modal-footer" style="text-align: center !important">
                        <form action="" data-url="{{ adminUrl('plannings') }}" method="post" style="display: none"
                            id="form-delete">
                            @csrf
                            @method('delete')
                        </form>
