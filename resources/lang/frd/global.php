...
return [
    ...
    "Action" => "Action",
    "Action Happened At" => "Débutée à",
    "Action Initiated By" => "Initiée par",
    "Action Name" => "Nom",
    ...
    "All resources loaded." => "Toutes les données ont été chargées.",
    "All rights reserved." => "Tous droits réservés.",
    "Already registered?" => "Déjà inscrit(e) ?",
    "American Samoa" => "Samoa américaines",
    "An error occured while uploading the file." => "Une erreur s'est produite lors de l'envoi du fichier.",
    "An error occurred while uploading the file." => "Une erreur s'est produite lors de l'envoi du fichier.",
    "An unexpected error occurred and we have notified our support team. Please try again later." => "Une erreur non souhaitée est apparue, et nous avons notifié notre support technique. Veuillez réessayer plus tard.",
    "Andorra" => "Andorre",
    "Angola" => "Angola",
    "Anguilla" => "Anguilla",
    "Another user has updated this resource since this page was loaded. Please refresh the page and try again." => "Une autre personne a mis à jour cette donnée depuis que cette page a été chargée. Veuillez rafraîchir la page et réessayer.",
    ...
    "Are you sure you want to delete this notification?" => "Êtes-vous sûr(e) de vouloir retirer cette notification ?",
    ...
    "Please enter your password to confirm you would like to logout of your other browser sessions across all of your devices." => "Veuillez entrer votre mot de passe pour confirmer que vous voulez déconnecter toutes les autres sessions de navigateurs sur l'ensemble de vos appareils.",
    ...
    "Please provide the email address of the person you would like to add to this team. The email address must be associated with an existing account." => "Veuillez indiquer l'adresse e-mail de la personne que vous souhaitez ajouter à cette équipe. L'adresse e-mail doit être associée à un compte existant.",
    ...
    "Two factor authentication is now enabled. Scan the following QR code using your phone's authenticator application." => "La double authentification est maintenant activée. Scannez le code QR suivant à l'aide de l'application d'authentification de votre téléphone.",
    "Uganda" => "Ouganda",
    "Ukraine" => "Ukraine",
